...
%  This is a custom-made time-performance-oriented override of the original
%  SIM function. Keep in mind, if you update the NN you have to call
%  UPDATESTRUCT before changes take effect.
%
