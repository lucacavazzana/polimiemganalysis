...
%   Last Revision: 13-Nov-2009.
%   Copyright 1995-2009 The MathWorks, Inc.
%   $Revision: 1.18.4.6 $ $Date: 2009/12/05 02:37:41 $
...
if nargin==6 && ~isequal(plotmode,'scal') && ~isequal(plotmode,'scalCNT')
...
switch dim_plot
  case 'SC'
      ...
      SC = wscalogram(typePLOT,coefs,scales,ySIG,xSIG);
